...
\begin{table}[H]
	...
	\begin{tabular}{p{2.9cm} | p{1.6cm} | p{0.8cm} | p{0.7cm} | p{1cm} | p{7.2cm}}\hline \hline
		\textbf{Atributo} & \textbf{Tipo} & \textbf{Long.} & \textbf{Nulo} & \textbf{Clave} & \textbf{Descripción} \\ \hline \hline
		\texttt{id\_distribuidor} & SERIAL & --- & No & PK & Identificador único \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{p{2.9cm} | p{1.6cm} | p{0.8cm} | p{0.7cm} | p{1cm} | p{7.2cm}}\hline \hline
		\textbf{Atributo} & \textbf{Tipo} & \textbf{Long.} & \textbf{Nulo} & \textbf{Clave} & \textbf{Descripción} \\ \hline \hline
		\texttt{id\_experto} & SERIAL & --- & No & PK & Identificador único \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} | p{1.6cm} | p{0.8cm} | p{0.7cm} | p{1cm} | p{6.3cm}}\hline \hline
		\textbf{Atributo} & \textbf{Tipo} & \textbf{Long.} & \textbf{Nulo} & \textbf{Clave} & \textbf{Descripción} \\ \hline \hline
		\texttt{id\_software} & SERIAL & --- & No & PK & Identificador único \\ \hline
...
\begin{figure}[H]
	...
	\caption{Listado de tablas (\texttt{\textbackslash dt}) y conteo de registros por tabla}
...
La transcripción completa en texto plano, tal como se copió de la sesión de \texttt{psql}, se conserva en el archivo \texttt{evidencia\_ejecucion.txt} entregado junto con este reporte:

\lstinputlisting[basicstyle=\scriptsize\ttfamily, caption={Transcripción completa de la ejecución de \texttt{script.sql} y de las consultas de validación, sobre PostgreSQL 16.15}, label={cod:evidencia}]{evidencia_ejecucion.txt}
