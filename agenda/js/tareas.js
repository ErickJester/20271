...
const TAREAS = [
  ...
  /* ---------- 7CM4 · Desarrollo de Aplicaciones Móviles Nativas ---------- */
  {
    ...
    parcial: 1,
    estado: "en-curso",
    descripcion: "Del PDF 'DAMN Kotlin Practica4' (operadores y estructuras de control): partiendo del verificador de números primos del profesor, Ejercicio 1 pide agregar si el número es Fibonacci y si es 'número maravilloso' (conjetura de Collatz: par->n/2, impar->3n+1, hasta llegar a 1); Ejercicio 2 pide que, si el número es de 3 o 4 dígitos, se verifique si corresponde a la constante de Kaprekar (495 o 6174). Código ya escrito y compilando en MainActivity.kt (BUILD SUCCESSFUL verificado); falta redactar y compilar el reporte AlumnoKotlinNumerosGrupo.doc que pide el PDF, armar el zip con la nomenclatura de la rúbrica y enviarlo. Sin fecha propia en la lista oficial de tareas; la rúbrica del profesor marca entrega semanal de prácticas de laboratorio, a más tardar el viernes de la semana correspondiente, al correo avionica252@yahoo.com (a reserva de otro medio por confirmar) — confirmar el viernes exacto con el profesor.",
    entregable: "NombreAlumno_KotlinNumeros_7CM4.zip con AlumnoKotlinNumerosGrupo.doc + código fuente (carpeta Parcial 1/practicas/Practica 4)",
    pasos: ["Completar esPrimo + esFibonacci + esMaravilloso (Ejercicio 1)", "Completar constante de Kaprekar para 3-4 dígitos (Ejercicio 2)", "Probar con varios números y capturar pantallas", "Redactar AlumnoKotlinNumerosGrupo.doc (carátula, introducción, desarrollo, conclusiones, bibliografía, código)", "Comprimir con la nomenclatura NombreAlumno_TipoDeTrabajo_Grupo.zip", "Confirmar fecha límite (viernes) con el profesor", "Enviar al correo indicado"],
  ...
  },
  {
    ...
    entregable: "Reporte con la estructura de la rúbrica + carpeta de código comprimida de la app standalone",
    pasos: ["Crear proyecto Android standalone en Java (constante de Kaprekar)", "Probar la app", "Redactar reporte (carátula, introducción, desarrollo, conclusiones, bibliografía)", "Comprimir código", "Entregar"],
    origen: "Plataforma del curso — entrega semanal de los viernes",
